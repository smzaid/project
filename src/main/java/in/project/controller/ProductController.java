...
import in.project.repo.ProductRepository;
...
public class ProductController {
	...
	public String edit(@RequestParam("pid") Integer pid, Model model) {
		...
		java.util.Optional<Product> findById = repo.findById(pid);
	...
	@PostMapping("/product")
	public String saveProduct(@Validated @ModelAttribute("product") Product p, BindingResult result,
											 Model model) {
